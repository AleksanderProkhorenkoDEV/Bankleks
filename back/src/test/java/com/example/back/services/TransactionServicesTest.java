...
public class TransactionServicesTest {
    ...
    // ─────────────────────────────────────────────
    // createScheduledTransaction — validaciones
    // ─────────────────────────────────────────────
    ...
    void shouldThrowWhenBalanceIsInsufficient() {
        ...
        CreateTransactionScheduledRequestDTO request = new CreateTransactionScheduledRequestDTO("pago", 200.0,
                destination.getAccountNumber(), origin.getAccountNumber(), "UTC", "10:00:00",
                List.of(futureDate, futureDate, futureDate), null, null);
    ...
    void shouldCreateOneScheduledTransferPerDate() {
        ...
        CreateTransactionScheduledRequestDTO request = new CreateTransactionScheduledRequestDTO("pago", 50.0,
                destination.getAccountNumber(), origin.getAccountNumber(), "UTC", "10:00:00",
                List.of(futureDate1, futureDate2), null, null);
        ...
        verify(transactionScheduledService, times(2)).createScheduledTransfer(
                ...
                any(Instant.class), eq("UTC"), isNull(), isNull());
    }
    ...
    void shouldCreateRecurrentScheduledTransfer() {
        ...
        CreateTransactionScheduledRequestDTO request = new CreateTransactionScheduledRequestDTO("suscripción", 50.0,
                destination.getAccountNumber(), origin.getAccountNumber(), "UTC", "10:00:00", List.of(futureDate),
    ...
    void shouldCreateRecurrentTransferWithNullEndDate() {
        ...
        CreateTransactionScheduledRequestDTO request = new CreateTransactionScheduledRequestDTO("pago recurrente", 50.0,
                destination.getAccountNumber(), origin.getAccountNumber(), "UTC", "10:00:00", List.of(futureDate),
                RecurrenceType.BEGINNING_OF_MONTH, null);
        ...
        verify(transactionScheduledService).createScheduledTransfer(
                ...
                any(Instant.class), eq("UTC"), eq(RecurrenceType.BEGINNING_OF_MONTH), isNull());
    }

    // ─────────────────────────────────────────────
    // createTransferTransaction (método interno usado por el scheduler)
    // ─────────────────────────────────────────────
